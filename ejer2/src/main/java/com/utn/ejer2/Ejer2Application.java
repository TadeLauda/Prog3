...
import com.utn.ejer2.entities.Domicilio;
import com.utn.ejer2.entities.Persona;
import com.utn.ejer2.repositories.PersonaRepository;
...
public class Ejer2Application {
	...
	CommandLineRunner init(PersonaRepository personaRepo) {
		return args -> {
			...
			/*El método builder() se genera automáticamente por Lomb y te permite crear una instancia
			de Persona.Builder. Luego, puedes encadenar llamadas a los métodos setters generados automáticamente
			para establecer los valores de los atributos de la clase. Finalmente, build() crea la instancia
